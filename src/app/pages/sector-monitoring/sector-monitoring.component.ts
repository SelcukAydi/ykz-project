...
@Component({
  selector: 'app-sector-monitoring',
  templateUrl: './sector-monitoring.component.html',
  styleUrls: ['./sector-monitoring.component.css']
})
export class SectorMonitoringComponent implements OnInit {
